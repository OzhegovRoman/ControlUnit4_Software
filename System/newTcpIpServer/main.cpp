...
int main(int argc, char *argv[])
{
    ...
    if (parser.isSet(fakeOptions)) {
        ...
        device2->installFakeInterface(tmpInterface);
        ...
        device3->installFakeInterface(tmpInterface);
        ...
        device4->installFakeInterface(tmpInterface);
        ...
        device5->installFakeInterface(tmpInterface);
        ...
        device6->installFakeInterface(tmpInterface);
